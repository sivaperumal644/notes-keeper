...
class DatabaseHelper{
  ...
  void _createDb(Database db, int newVersion) async {
    await db.execute('CREATE TABLE $noteTable($noteId INTEGER PRIMARY KEY AUTOINCREMENT, $noteTitle TEXT, $noteDescription TEXT, $notePriority INTEGER, $noteDate TEXT);');
  }
